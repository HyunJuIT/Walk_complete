...
public class ShareRouteAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ShareRouteAdapter(ArrayList<MyRouteVO> mData) {
        this.mData = mData;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 2:
                ...
                ShareRouteAdapter.ViewHolder vh = new ShareRouteAdapter.ViewHolder(view);

                return vh;
            case 1:
                view = inflater.inflate(R.layout.my_route, parent, false);
                ShareRouteAdapter.ViewHolderMyroute vh1 = new ShareRouteAdapter.ViewHolderMyroute(view);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (mData.get(position).getId().equals(MainActivity.email)) {
            ...
            ViewHolderMyroute viewHolderMyroute = (ViewHolderMyroute) holder;
