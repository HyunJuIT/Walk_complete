...
public class MyFavoriteFeedAdapter extends RecyclerView.Adapter<MyFavoriteFeedAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            item = itemView.findViewById(R.id.writing_feed);
    ...
    MyFavoriteFeedAdapter(ArrayList<FeedVO> list) {
        mData = list;
    }

    // onCreateViewHolder() - 아이템 뷰를 위한 뷰홀더 객체 생성하여 리턴.
    @Override
    public MyFavoriteFeedAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        context = parent.getContext();
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        View view = inflater.inflate(R.layout.feed_img, parent, false);
        MyFavoriteFeedAdapter.ViewHolder vh = new MyFavoriteFeedAdapter.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(MyFavoriteFeedAdapter.ViewHolder holder, int position) {

        if (mData.get(position).getFavorite_main().contains(MainActivity.email)) {
            /*     try {*/
...
/*
            ...
            holder.favorite.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    MyFavoriteFeed.handler.sendEmptyMessage(1);
                }
            });
